...
import com.algasensors.temperature.monitoring.application.usecase.monitoring.impl.EnableSensorMonitoringUseCaseImpl;
...
class EnableSensorMonitoringUseCaseImplTest {

    @Mock
    private SensorMonitoringGateway sensorMonitoringGateway;

    @InjectMocks
    private EnableSensorMonitoringUseCaseImpl useCase;

    @Test
    void shouldEnableAndSaveSuccessfully() {
        ...
        try (MockedStatic<SensorMonitoring> mockedStatic = mockStatic(SensorMonitoring.class)) {
            ...
            mockedStatic.verify(() -> SensorMonitoring.enable(sensorMonitoring));
